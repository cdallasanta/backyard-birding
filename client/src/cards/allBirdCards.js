...
export const birdCards = [
  ...
  { id: 14, src: birds["darkEyedJunco.png"], name: "Dark Eyed Junco", flightNums: [5,6], season: "any", habitat: ["seeds", "bushedAndFlowers"] },
  ...
  { id: 32, src: birds["rufousHummingbird.png"], name: "Rufous Hummingbird", flightNums: [5,6], season: "spring", habitat: ["trees", "flowersAndBushes"] },
  { id: 33, src: birds["songSparrow.png"], name: "Song Sparrow", flightNums: [1,2], season: "any", habitat: ["seeds", "flowersAndBushes"] },
  { id: 34, src: birds["spottedTowhee.png"], name: "Spotted Towhee", flightNums: [3,4], season: "summer", habitat: ["seeds", "flowersAndBushes"] },
